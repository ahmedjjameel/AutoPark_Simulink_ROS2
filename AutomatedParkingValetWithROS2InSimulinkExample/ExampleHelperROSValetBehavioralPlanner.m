%ExampleHelperROSValetBehavioralPlanner Behavioral planner helper class.
...
%
%   behaviorPlanner = ExampleHelperROSValetBehavioralPlanner(routePlan, steerLimit) 
...
%
%   ExampleHelperROSValetBehavioralPlanner properties: 
%   RoutePlan   - Global route plan.
%
%   ExampleHelperROSValetBehavioralPlanner methods: 
...
classdef ExampleHelperROSValetBehavioralPlanner < handle
    ...
    methods
        %------------------------------------------------------------------
        function this = ExampleHelperROSValetBehavioralPlanner(routePlan, steerLimit)
