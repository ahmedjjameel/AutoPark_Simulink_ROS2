function varargout = exampleHelperROSValetPlotVehicle(varargin)
%exampleHelperROSValetPlotVehicle plot a vehicle.
%
%   exampleHelperROSValetPlotVehiclevehiclePose, vehicleDims) plots a vehicle on the
...
%
%   exampleHelperROSValetPlotVehicle(vehiclePose, vehicleDims, steer) additionally orients
%   the wheels using steering angle specified by steer (in degrees).
%
%   exampleHelperROSValetPlotVehicle(...,Name,Value) specifies additional name-value pair
...
%   hold on
%   exampleHelperROSValetPlotVehicle(vehiclePose, vehicleDims, steerAngle, ...
%       'DisplayName', 'car')
%
%   % Focus on vehicle
...
carShapes = exampleHelperROSValetVehiclePolyshape(vehiclePose, vehicleDims, steer);
