classdef ExampleHelperROSValetPathAnalyzer < matlab.System
%ExampleHelperROSValetPathAnalyzer Provide reference inputs for vehicle controllers.
%   ExampleHelperROSValetPathAnalyzer computes the reference pose and the reference
%   velocity based on the current pose of the vehicle.
%
%   pathAnalyzer = ExampleHelperROSValetPathAnalyzer creates a system object,
%   pathAnalyzer, that calculate reference inputs for vehicle controllers.
%
%   pathAnalyzer = ExampleHelperROSValetPathAnalyzer(Name,Value) creates a system object,
...
%
%   ExampleHelperROSValetPathAnalyzer properties:
%   Wheelbase              - Wheelbase of the vehicle
...
%
%   ExampleHelperROSValetPathAnalyzer methods:
...
%
%   See also lateralControllerStanley, ExampleHelperROSValetLongitudinalController,
%     smoothPathSpline, exampleHelperROSValetGenerateVelocityProfile
...
%#codegen
    ...
    properties(Access = private, Nontunable)
        ...
        %
        HasReferenceInports (1, 1) logical
    end
    ...
    methods
        ...
        %------------------------------------------------------------------
        function obj = ExampleHelperROSValetPathAnalyzer(varargin)
            %ExampleHelperROSValetPathAnalyzer Constructor 
    ...
    methods(Access = protected)
        ...
        function [refPose, refVel, direction, curvature, varargout] = stepImpl(obj, ...
            ...
            reset = 0;
            if exampleHelperROSValetGoalChecker(nextGoal, currPose, currVel, endRefVel, direction)
